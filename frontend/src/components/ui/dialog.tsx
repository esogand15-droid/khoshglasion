 ...
 */
const widths = { sm: "max-w-sm", md: "max-w-md", lg: "max-w-3xl" };

export function Dialog({ open, onOpenChange, title, description, children, footer, role = "dialog", size = "md", className }: DialogProps) {

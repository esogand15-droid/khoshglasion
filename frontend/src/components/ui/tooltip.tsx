  ...
  return (
    <span className={cn("group/tt relative inline-flex", className)}>
      ...
      <span
        ...
        role="tooltip"
        className={cn(
          "pointer-events-none absolute left-1/2 z-30 w-max max-w-56 -translate-x-1/2 rounded-md bg-foreground px-2.5 py-1 text-xs text-background opacity-0 shadow transition-opacity duration-[var(--duration-fast)]",

...
PRIORITY: list[tuple[list[str], str]] = [
    ...
    (["تبلیغ", "اسپانسر", "همکاری تبلیغاتی"], "ad"),
    (["پرسش و پاسخ", "سوالات متداول"], "qa"),
    (["نکته آموزشی", "آموزش درس"], "lesson"),
]
...
RULES: list[tuple[list[str], str]] = [
    ...
    (["آزمون", "قلم‌چی", "قلم چی", "امتحان", "کنکور", "ماز", "گزینه دو", "گاج", "تست‌زنی", "تست زنی", "تست", "جمع‌بندی", "جمع بندی"], "exam"),
